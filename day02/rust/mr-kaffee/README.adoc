...
It would have been much simpler to parse both into 0, 1, 2 and than use some simple formulas later on, but my solution fails gracefully if something unexpected comes in the input ;)
