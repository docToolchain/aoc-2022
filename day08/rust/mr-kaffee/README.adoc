...
I directly use the bytes from the input. I scan for the first occurance of a line break. Its index is the width of the grid. The `PuzzeData` struct's implementation has an additional field for the `height` of the grid.
